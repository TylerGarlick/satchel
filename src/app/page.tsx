...
import { MySatchel } from '@/components/MySatchel';
...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Show MySatchel view when wallet is connected */}
      {isConnected ? (
        <MySatchel />
      ) : (
        <>
          ...
          <section className="py-12 text-center">
            <div className="bg-gray-800 max-w-md mx-auto p-8 rounded-lg border border-gray-700">
              <h3 className="text-2xl font-semibold mb-4">Connect Your Wallet</h3>
              <p className="text-gray-400 mb-6">
                Connect your Algorand wallet to view your earned badges and manage your Satchel collection.
              </p>
              <ConnectButton />
            </div>
          </section>
